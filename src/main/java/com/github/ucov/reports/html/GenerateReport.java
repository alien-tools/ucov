...
public class GenerateReport {
    ...
    private String getTdStringForOneELement(int i, int percentageTested, int nbTested, int percentageHalfTested, int nbHalfTested, int percentageNoTested, int nbNoTested) {
        ...
        return "<td class='column'>" +
                "<button type='button' class='bouton' data-bs-toggle='tooltip' data-bs-html='true' data-bs-title='<div>Tested : " + percentageTested + "% | " + nbTested + "</div><div>Half Tested : " + percentageHalfTested + "% | " + nbHalfTested + "</div><div>No Tested : " + percentageNoTested + "% | " + nbNoTested + "</div>'>" +
                "<canvas id = 'TestedCanvas_" + i + "' width=" + percentageTested + " height=" + height + "></canvas>" +
                "<canvas id = 'HalfTestedCanvas_" + i + "' width=" + percentageHalfTested + " height=" + height + "></canvas>" +
                "<canvas id = 'NoTestedCanvas_" + i + "' width=" + percentageNoTested + " height=" + height + "></canvas>" +
                "</button></td>";
    }
